  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "headline-lg": ['"Tajawal"', '"Cairo"', 'sans-serif'],
        "body-md": ['"Cairo"', '"Tajawal"', 'sans-serif'],
        "body-lg": ['"Cairo"', '"Tajawal"', 'sans-serif'],
        "headline-xl": ['"Tajawal"', '"Cairo"', 'sans-serif'],
        "label-sm": ['"Tajawal"', 'sans-serif'],
        "display-lg": ['"Tajawal"', '"Cairo"', 'sans-serif'],
        "display-lg-mobile": ['"Tajawal"', '"Cairo"', 'sans-serif'],
        "label-md": ['"Tajawal"', 'sans-serif'],
        "headline-md": ['"Tajawal"', '"Cairo"', 'sans-serif'],
