...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        display: ['var(--font-tajawal)', 'var(--font-cairo)', 'var(--font-poppins)', 'system-ui', 'sans-serif'],
        sans: ['var(--font-tajawal)', 'var(--font-cairo)', 'var(--font-poppins)', 'system-ui', 'sans-serif'],
        "headline-lg": ['var(--font-tajawal)', 'var(--font-cairo)', 'sans-serif'],
        "body-md": ['var(--font-cairo)', 'var(--font-tajawal)', 'sans-serif'],
        "body-lg": ['var(--font-cairo)', 'var(--font-tajawal)', 'sans-serif'],
        "headline-xl": ['var(--font-tajawal)', 'var(--font-cairo)', 'sans-serif'],
        "label-sm": ['var(--font-tajawal)', 'sans-serif'],
        "display-lg": ['var(--font-tajawal)', 'var(--font-cairo)', 'sans-serif'],
        "display-lg-mobile": ['var(--font-tajawal)', 'var(--font-cairo)', 'sans-serif'],
        "label-md": ['var(--font-tajawal)', 'sans-serif'],
        "headline-md": ['var(--font-tajawal)', 'var(--font-cairo)', 'sans-serif'],
      ...
      fontSize: {
        ...
        "4xl": ["36px", { lineHeight: "1.2", fontWeight: "800" }],
        "5xl": ["48px", { lineHeight: "1.15", fontWeight: "800" }],
        "6xl": ["60px", { lineHeight: "1.1", fontWeight: "900" }],
