  ...
  return (
    <html lang="ar" dir="rtl">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@200..1000&family=Tajawal:wght@400;500;700;800;900&family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet" />
        ...
        <footer className="bg-on-background text-surface-bright py-12 md:py-16 px-margin-mobile md:px-margin-desktop w-full rtl">
          <div className="max-w-container-max mx-auto flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12">
            <div className="max-w-sm">
              <img src="/w-%20logo.png" alt="تك ميكرز" className="h-12 w-auto mb-6" />
            ...
            <div className="grid grid-cols-2 gap-12 md:gap-24">
              <div>
                <h5 className="font-label-md text-label-md text-white mb-6">الروابط السريعة</h5>
                <ul className="flex flex-col gap-3">
                  <li><Link href="/about" className="text-surface-variant/70 hover:text-secondary-fixed transition-colors">من نحن</Link></li>
                  <li><Link href="/tracks" className="text-surface-variant/70 hover:text-secondary-fixed transition-colors">المسارات التعليمية</Link></li>
                  <li><Link href="/#faq" className="text-surface-variant/70 hover:text-secondary-fixed transition-colors">الأسئلة الشائعة</Link></li>
                </ul>
              </div>
              <div>
          ...
          <div className="max-w-container-max mx-auto mt-16 pt-8 border-t border-outline-variant/10 text-center">
            <p className="text-surface-variant/70 font-label-sm text-label-sm">© 2026 TKA-Egypt. جميع الحقوق محفوظة.</p>
          </div>
        </footer>
      </body>
    </html>
