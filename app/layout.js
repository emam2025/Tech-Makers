  ...
  return (
    <html lang="ar" dir="rtl" className={`${tajawal.variable} ${cairo.variable} ${poppins.variable}`}>
      <head>
        ...
        <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@14..48,100..400,0..1,-50..200&display=swap" />
        <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@14..48,100..400,0..1,-50..200&display=swap" rel="stylesheet" media="print" onLoad="this.media='all'" />
        <noscript><link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@14..48,100..400,0..1,-50..200&display=swap" rel="stylesheet" /></noscript>
      </head>
