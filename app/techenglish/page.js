        ...
        <div className="max-w-container-max mx-auto">
          <div className="text-center mb-12">
            <span className="inline-block bg-tertiary/10 text-tertiary px-5 py-2 rounded-full font-label-md mb-4 border border-tertiary/20">
              <span className="material-symbols-outlined text-sm align-middle">emoji_events</span> لماذا Tech English؟
            </span>
            <h2 className="font-headline-xl text-headline-lg md:text-headline-xl text-primary mb-3">نقطة تميّز عن السوق</h2>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-headline-md text-headline-md text-red-700">لا تكتبوا</h3>
                </div>
                <p className="text-red-600 font-body-lg text-lg">&quot;تعليم اللغة الإنجليزية&quot;</p>
              </div>

              <div className="flex justify-center">
                <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center">
                  <span className="material-symbols-outlined text-white text-2xl">arrow_down</span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-6 border border-green-200">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-headline-md text-headline-md text-green-700">اكتبوا</h3>
                </div>
                <p className="text-green-700 font-headline-lg text-xl font-bold">Tech English</p>
                <p className="text-green-600 font-body-md">لغة المستقبل لأطفال المستقبل</p>
              </div>
            </div>

            <div className="bg-gradient-to-br from-primary/5 to-blue-50 rounded-3xl p-8 border border-primary/10">
              <h3 className="font-headline-lg text-headline-lg text-primary mb-4">لماذا Tech English وليس إنجليزي عادي؟</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-primary-deep">الطالب لا يتعلم الإنجليزية لكي ينجح في اختبار</h4>
                    <p className="text-on-surface-variant text-xs">بل لكي يدخل عالم التكنولوجيا بثقة</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-primary-deep">مفردات تقنية حقيقية</h4>
                    <p className="text-on-surface-variant text-xs">AI, Programming, Cybersecurity — وليس فقط greetings و numbers</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="material-symbols-outlined text-blue-600 text-lg">rocket_launch</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-sm text-primary-deep">مسار وظيفي واضح</h4>
                    <p className="text-on-surface-variant text-xs">من المبتدئ إلى المحترف في 12 شهر</p>
                  </div>
                </div>
              </div>
            </div>
